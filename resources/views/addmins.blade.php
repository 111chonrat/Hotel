...
<body class="app sidebar-mini">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      <li><a class="app-menu__item active" href="createhotel"><i class="app-menu__icon fa fa-wpforms"></i><span
            class="app-menu__label">Forms Add</span></a></li>
            <li><a class="app-menu__item" href="add-img"><i class="app-menu__icon fa fa-wpforms"></i><span
          ...
          <div class="tile-body">
            <form  method="POST" action="createhotel">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="detail" placeholder="Enter your detail"></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="tel" placeholder="Enter tel ">
              </div>
