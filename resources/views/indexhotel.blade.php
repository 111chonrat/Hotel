...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="80">
		...
		<div class="navbar navbar-default navbar-fixed-top menu-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="#" class="navbar-brand"><img src="assets1/img/logo1-1.png" alt="logo"></a>
                    </div>
				<div class="navbar-collapse collapse">
					...
					<nav>
						<ul class="nav navbar-nav navbar-right">
                            ...
                            &gacute;
                            <li><a class="page-scroll" href="login">Login Admin</a></li>
						</ul>
                    </nav>
				</div>
			</div><!--- END CONTAINER -->
										...
										<div class="container">
											<div class="row">
												<div class="col-md-12">
													...
													<h2>Get your best meal here</h2>
													<p>The website of your restaurant.</p>
													<a class="btn btn-default btn-light-bg page-scroll" href="#reservation">Explore</a> -->
												</div>
											</div>
										</div>
        ...
        <!-- START Hotel -->
        @foreach($Rawdata["name"] as $data)

		<section id="hotel" class="hotel_us section-padding">
			<div class="container">
				<div class="row">
                   <div class="col-md-7 col-sm-12 col-xs-12">
                        <div class="hotel-slide">
                                <img src=" {{ $data}} " class="img-responsive" alt="" />
                   ...
                   <div class="col-md-5 col-sm-12 col-xs-12">
						<div class="hotel_content">
                            <h1>{{$data}} </h1>
							{{-- <h3> พลอยอินน์ โฮเต็ล หนองคาย </h3>
							<br>
                            <p>อันดับ 1 จากโรงแรมในภูมิภาคจังหวัดหนองคายทั้งหมด 29 แห่ง และอันดับ 1 จาก โรงแรมในหนองคายทั้งหมด 26 แห่ง</p> --}}
                            <form method="POST" action="readmore">
                                <input type="hidden" name="hotel_name" value="{{$data}}">
                            <button  type="submit" class="btn btn-default btn-light-bg page-scroll" href="detel">Read more</button>
                            </form>
                        </div>
                    </div><!--- END COL -->
				</div><!-- END ROW  -->
			</div><!-- END CONTAINER  -->@endforeach
		</section>
		<!-- END Hotel -->
